...
public abstract class TargetScreen implements Screen{
	...
	public TargetScreen(Combatant figure, Board board, MeasureType measure){
	...
	protected Combatant getFigure(){return this.figure;}
	...
	protected boolean inRangeEuclidean(int i, int j){
		if(Trig.euclideanDistanceBetweenPoints(this.figure.getWidthPos(), this.figure.getHeightPos(), i, j) <= (double)(this.getMaxRange()))
			return true;
		return false;
	}
	
	protected boolean inRangeManhattan(int i, int j){
		if(Trig.manhattanDistanceBetweenPoints(this.figure.getWidthPos(), this.figure.getHeightPos(), i, j) <= (double)(this.getMaxRange()))
			return true;
		return false;
	}
