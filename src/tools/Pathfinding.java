...
public class Pathfinding {
	...
	public static Node[][] findPathableNodes(Combatant figure, Board board, int range){
		return findPathableNodes(figure.getWidthPos(), figure.getHeightPos(), board, range);
	}
	
	public static Node[][] findNodesInRange(Combatant figure, Board board, int range, boolean ignoreBlockingTiles){
