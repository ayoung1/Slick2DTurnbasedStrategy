...
public class CharacterActionMenu {
	...
	public CharacterActionMenu(SpriteSheet spriteSheet, Combatant figure, Button ... buttons){
	...
	private void setButtonLocations(){
		int[] coords = new int[]{figure.getWidthPos(), figure.getHeightPos()};
